...
export default function Home() {
  return (
    <>
      ...
      <div className="w-[75rem] h-[20rem] absolute top-[36rem] left-36 flex items-center justify-center bg-[rgba(255,255,255,0.3)] rounded-[10px] mx-auto mt-14">
      ...
      <section className='bg-yellow-50'>
        <div className='relative mt-12 pt-12 w-[85%] mx-auto'> 
        <Image
        ...
        <div className='mt-24 flex flex-col gap-7'>
            <div className='flex items-center'>
              <h5 className='text-slate-800 h-14 w-14 flex justify-center items-center text-5xl font-bold bg-orange-100 rounded-full p-4'>1</h5>
            <div className='ml-12'>
                <p className='text-slate-800 text-2xl font-bold mb-2 '>Step 1 text goes here</p>
                <p className='text-slate-800 text-lg font-medium leading-[3rem]'>Lorem ipsum dolor sit amet, consectetur adipiscing <br /> elit, sed do eiusmod tempor incididunt ut labore</p>
              </div>
            </div>
            <div className='flex items-center'>
              <h5 className='text-slate-800 h-14 w-14 flex justify-center items-center text-5xl font-bold bg-orange-100 rounded-full p-4'>2</h5>
            <div className='ml-12'>
                <p className='text-slate-800 text-2xl font-bold mb-2 '>Step 1 text goes here</p>
                <p className='text-slate-800 text-lg font-medium leading-[3rem]'>Lorem ipsum dolor sit amet, consectetur adipiscing <br /> elit, sed do eiusmod tempor incididunt ut labore</p>
              </div>
            ...
            <div className='flex items-center'>
              <h5 className='text-slate-800 h-14 w-14 flex justify-center items-center text-5xl font-bold bg-orange-100 rounded-full p-4'>3</h5>
            <div className='ml-12'>
      ...
      <section className=' bg-slate-50'>
        ...
        <div className='py-6 px-8 bg-white shadow rounded-[5px]'>
          <Image
            src="/icons/tick.svg"
            alt="tick"
            height={48}
            ...
            <p className='text-slate-800 text-base font-normal leading-[3rem]'>Lorem ipsum dolor sit , consectetur <br /> adipiscing elit.</p>
        </div>
        <div className='py-6 px-8 bg-white shadow rounded-[5px]'>
          <Image
            src="/icons/tick.svg"
